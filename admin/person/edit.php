							...
							<div class="panel-body">
								...
								<form id="jvalidate" role="form" class="form-horizontal" action="http://localhost/kopkardemo/admin/person/store.php" name="kopkar" method="POST">
									...
									<div class="form-group">
										...
										<div class="col-md-5">
											<input type="text" class="form-control" name="Salary" value="<?php echo $data->Salary ?>" onKeydown="return numbersonly(this, event)" onKeyup="javascript:tandaPemisahTitik(this);" />
										</div>
									</div>
