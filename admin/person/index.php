								...
								<ul class="panel-controls">
									...
									<li class="dropdown">
										...
										<ul class="dropdown-menu">
											<li><a href="<?php echo BASE_URL.'admin/person/add.php' ?>"><span class="glyphicon glyphicon-pencil"></span> Add</a></li>
										</ul>
									</li>
								</ul>
							</div>
									...
									<tbody>
										...
										while ($listData = $query->mfArray($getData)) {
											echo "<tr>";
												...
												echo "<td>".$listData['FullName']."</td>";
												echo "<td>".$listData['Salary']."</td>";
												echo "<td width='200px'>";
												echo "<div class='btn-group' role='group'>";
													echo "<a href='".BASE_URL."admin/person/view.php?id=".$listData['Nik']."' class='btn btn-info btn-sm'>View</a>";
													echo "<a href='".BASE_URL."admin/person/edit.php?id=".$listData['Nik']."' class='btn btn-info btn-sm'>Edit</a>";
													echo '<a href="'.BASE_URL.'admin/person/store.php?id='.$listData['Nik'].'" class="btn btn-info btn-sm" onClick="return confirm(\'Are you sure delete this data?\')">Delete</a>';
												echo "</div>";
												echo "</td>";
											echo "</tr>";
										}
