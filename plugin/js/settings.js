var site_settings = '<div class="ts-button">'
    ...
    +'<div class="ts-body">'
        ...
        +'<div class="ts-themes">'
            +'<a href="#" class="active" data-theme="http://localhost/kopkardemo/plugin/css/theme-default.css"><img src="http://localhost/kopkardemo/plugin/img/themes/default.jpg"/></a>'            
            +'<a href="#" data-theme="http://localhost/kopkardemo/plugin/css/theme-forest.css"><img src="http://localhost/kopkardemo/plugin/img/themes/forest.jpg"/></a>'
            +'<a href="#" data-theme="http://localhost/kopkardemo/plugin/css/theme-dark.css"><img src="http://localhost/kopkardemo/plugin/img/themes/dark.jpg"/></a>'                        
            +'<a href="#" data-theme="http://localhost/kopkardemo/plugin/css/theme-night.css"><img src="http://localhost/kopkardemo/plugin/img/themes/night.jpg"/></a>'            
            +'<a href="#" data-theme="http://localhost/kopkardemo/plugin/css/theme-serenity.css"><img src="http://localhost/kopkardemo/plugin/img/themes/serenity.jpg"/></a>'
            
            +'<a href="#" data-theme="http://localhost/kopkardemo/plugin/css/theme-default-head-light.css"><img src="http://localhost/kopkardemo/plugin/img/themes/default-head-light.jpg"/></a>'
            +'<a href="#" data-theme="http://localhost/kopkardemo/plugin/css/theme-forest-head-light.css"><img src="http://localhost/kopkardemo/plugin/img/themes/forest-head-light.jpg"/></a>'    
            +'<a href="#" data-theme="http://localhost/kopkardemo/plugin/css/theme-dark-head-light.css"><img src="http://localhost/kopkardemo/plugin/img/themes/dark-head-light.jpg"/></a>'            
            +'<a href="#" data-theme="http://localhost/kopkardemo/plugin/css/theme-night-head-light.css"><img src="http://localhost/kopkardemo/plugin/img/themes/night-head-light.jpg"/></a>'
            +'<a href="#" data-theme="http://localhost/kopkardemo/plugin/css/theme-serenity-head-light.css"><img src="http://localhost/kopkardemo/plugin/img/themes/serenity-head-light.jpg"/></a>'
